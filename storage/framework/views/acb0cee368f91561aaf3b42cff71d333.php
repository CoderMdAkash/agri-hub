<?php $__env->startSection('title', 'Manage Agri News & Articles'); ?>
<?php $__env->startSection('page_title', 'Agricultural News & Research Articles'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <a href="<?php echo e(route('admin.blogs.create')); ?>" class="px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-sm transition-all shadow-sm flex items-center gap-2">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50/80 transition-colors">
                            <td class="px-6 py-4">
                                <img src="<?php echo e(asset($blog->image ?? 'frontend/images/news1.jpg')); ?>" alt="<?php echo e($blog->title); ?>" class="w-16 h-11 rounded-lg object-cover border">
                            </td>
                            ...
                            <td class="px-6 py-4 text-xs text-gray-400">
                                <?php echo e($blog->created_at ? $blog->created_at->format('M d, Y') : 'Draft'); ?>

                            </td>
                            <td class="px-6 py-4 text-right space-x-2">
                                <a href="<?php echo e(route('admin.blogs.edit', $blog->id)); ?>" class="text-xs font-semibold text-indigo-600 hover:text-indigo-900 bg-indigo-50 px-3 py-1.5 rounded-lg border border-indigo-100 inline-block">
                                    Edit
                                </a>
                                <form action="<?php echo e(route('admin.blogs.destroy', $blog->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this article?')">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\NSDA\agri-hub\resources\views/admin/blogs/index.blade.php ENDPATH**/ ?>