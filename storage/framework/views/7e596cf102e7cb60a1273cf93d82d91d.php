...
<body class="bg-[#1C2434] min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
        ...
        <form action="<?php echo e(route('login')); ?>" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" id="email" value="<?php echo e(old('email', 'admin@gmail.com')); ?>" required 
        ...
        <div class="mt-8 pt-6 border-t border-gray-100 text-center">
            ...
            <a href="<?php echo e(route('home')); ?>" class="inline-block mt-3 text-xs font-semibold text-indigo-600 hover:underline">
...
<?php /**PATH D:\laragon\www\NSDA\agri-hub\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>