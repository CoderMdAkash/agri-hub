<?php $__env->startSection('title', 'Manage Farming Guides'); ?>
<?php $__env->startSection('page_title', 'Farming Guides & Tutorials'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <a href="<?php echo e(route('admin.farming-guides.create')); ?>" class="px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-sm transition-all shadow-sm flex items-center gap-2">
                        ...
                        <tr class="hover:bg-gray-50/80 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <span class="inline-flex px-2.5 py-1 rounded-full text-xs font-semibold bg-emerald-50 text-emerald-700 border border-emerald-100">
                                    <?php echo e($guide->category); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 text-xs font-medium text-gray-600">
                                <?php echo e($guide->season ?? 'Year-round'); ?>

                            </td>
                            <td class="px-6 py-4 text-xs text-gray-500">
                                <?php echo e($guide->order); ?>

                            </td>
                            <td class="px-6 py-4 text-right space-x-2">
                                <a href="<?php echo e(route('admin.farming-guides.edit', $guide->id)); ?>" class="text-xs font-semibold text-indigo-600 hover:text-indigo-900 bg-indigo-50 px-3 py-1.5 rounded-lg border border-indigo-100 inline-block">
                                    Edit
                                </a>
                                <form action="<?php echo e(route('admin.farming-guides.destroy', $guide->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this guide?')">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\NSDA\agri-hub\resources\views/admin/farming_guides/index.blade.php ENDPATH**/ ?>