...
<div class="max-w-2xl mx-auto bg-white rounded-2xl border border-gray-100 shadow-sm p-8 space-y-6">
    ...
    <div class="p-4 bg-purple-50 border border-purple-100 rounded-xl space-y-2">
        <label class="block text-xs font-bold text-purple-800 uppercase tracking-wider">Attached File / Field Photo</label>
        <a href="{{ asset('storage/' . $message->attachment) }}" target="_blank" class="inline-flex items-center gap-2 px-4 py-2 bg-purple-600 text-white rounded-lg text-xs font-semibold hover:bg-purple-700">
            <i class="fa-solid fa-paperclip"></i> View / Download Attachment
        </a>
    </div>
    @endif
