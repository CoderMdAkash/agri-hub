...
@section('title', 'Agricultural Information Hub - Admin Dashboard')
@section('page_title', 'Agri-Hub Overview & Statistics')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center justify-between">
            <div>
                ...
                <div class="text-3xl font-bold text-gray-900 mt-1">{{ $stats['farming_guides'] }}</div>
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center justify-between">
            <div>
                ...
                <div class="text-3xl font-bold text-gray-900 mt-1">{{ $stats['crop_details'] }}</div>
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center justify-between">
            <div>
                ...
                <div class="text-3xl font-bold text-gray-900 mt-1">{{ $stats['pest_controls'] }}</div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <table class="w-full text-left text-sm text-gray-600">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse($recentMessages as $msg)
                            <tr class="hover:bg-gray-50/80 transition-colors {{ !$msg->is_read ? 'font-semibold bg-emerald-50/30' : '' }}">
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <a href="{{ route('admin.messages.show', $msg->id) }}" class="text-xs text-emerald-600 hover:text-emerald-900 font-semibold">
                                        View Details
                                    </a>
                                </td>
                            </tr>
        ...
        <div class="space-y-6">
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                ...
                <div class="space-y-3">
                    <a href="{{ route('admin.farming-guides.create') }}" class="w-full flex items-center justify-between p-3.5 rounded-xl bg-emerald-50 hover:bg-emerald-100 text-emerald-800 font-semibold text-sm transition-colors">
                        <span><i class="fa-solid fa-plus me-2"></i> Add Farming Guide</span>
                        <i class="fa-solid fa-chevron-right text-xs"></i>
                    </a>
                    <a href="{{ route('admin.crop-details.create') }}" class="w-full flex items-center justify-between p-3.5 rounded-xl bg-amber-50 hover:bg-amber-100 text-amber-800 font-semibold text-sm transition-colors">
                        <span><i class="fa-solid fa-plus me-2"></i> Add Crop Profile</span>
                        <i class="fa-solid fa-chevron-right text-xs"></i>
                    </a>
                    <a href="{{ route('admin.pest-controls.create') }}" class="w-full flex items-center justify-between p-3.5 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-800 font-semibold text-sm transition-colors">
                        <span><i class="fa-solid fa-plus me-2"></i> Add Pest Control Strategy</span>
                        <i class="fa-solid fa-chevron-right text-xs"></i>
                    </a>
                    <a href="{{ route('admin.blogs.create') }}" class="w-full flex items-center justify-between p-3.5 rounded-xl bg-blue-50 hover:bg-blue-100 text-blue-800 font-semibold text-sm transition-colors">
                        <span><i class="fa-solid fa-newspaper me-2"></i> Publish Agri News Article</span>
                        <i class="fa-solid fa-chevron-right text-xs"></i>
                    </a>
                    <a href="{{ route('admin.messages.index') }}" class="w-full flex items-center justify-between p-3.5 rounded-xl bg-indigo-50 hover:bg-indigo-100 text-indigo-800 font-semibold text-sm transition-colors">
