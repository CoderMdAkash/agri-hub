        ...
        <aside class="fixed inset-y-0 left-0 z-40 w-64 bg-[#1C2434] text-gray-300 transition-transform duration-300 transform lg:translate-x-0 lg:static lg:inset-0 flex flex-col"
            ...
            <div class="flex-1 overflow-y-auto no-scrollbar px-4 py-6 space-y-1">
                ...
                <a href="{{ route('admin.dashboard') }}" 
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium text-sm transition-all {{ request()->routeIs('admin.dashboard') ? 'bg-emerald-600 text-white' : 'hover:bg-gray-800 hover:text-white' }}">
                    <i class="fa-solid fa-chart-pie w-5"></i>
                    <span>Dashboard</span>
                </a>

                <a href="{{ route('admin.farming-guides.index') }}" 
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium text-sm transition-all {{ request()->routeIs('admin.farming-guides.*') ? 'bg-emerald-600 text-white' : 'hover:bg-gray-800 hover:text-white' }}">
                    <i class="fa-solid fa-book-open-reader w-5"></i>
                    <span>Farming Guides</span>
                </a>

                <a href="{{ route('admin.crop-details.index') }}" 
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium text-sm transition-all {{ request()->routeIs('admin.crop-details.*') ? 'bg-emerald-600 text-white' : 'hover:bg-gray-800 hover:text-white' }}">
                    <i class="fa-solid fa-wheat-awn w-5"></i>
                    <span>Crop Details</span>
                </a>

                <a href="{{ route('admin.pest-controls.index') }}" 
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium text-sm transition-all {{ request()->routeIs('admin.pest-controls.*') ? 'bg-emerald-600 text-white' : 'hover:bg-gray-800 hover:text-white' }}">
                    <i class="fa-solid fa-bugs w-5"></i>
                    <span>Pest Control (IPM)</span>
                </a>

                <a href="{{ route('admin.blogs.index') }}" 
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium text-sm transition-all {{ request()->routeIs('admin.blogs.*') ? 'bg-emerald-600 text-white' : 'hover:bg-gray-800 hover:text-white' }}">
                    <i class="fa-solid fa-newspaper w-5"></i>
                    <span>Agri News & Articles</span>
                </a>

                <a href="{{ route('admin.messages.index') }}" 
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium text-sm transition-all {{ request()->routeIs('admin.messages.*') ? 'bg-emerald-600 text-white' : 'hover:bg-gray-800 hover:text-white' }}">
                ...
                <a href="{{ route('admin.services.index') }}" 
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium text-sm transition-all {{ request()->routeIs('admin.services.*') ? 'bg-emerald-600 text-white' : 'hover:bg-gray-800 hover:text-white' }}">
