...
@section('title', 'Crop Details & Profiles - Agricultural Information Hub')

@section('meta_description', 'Detailed crop profiles for grains, fruits, vegetables, and cash crops including soil requirements, cultivation, harvesting, and nutritional values.')
            ...
            <div class="row">
               <div class="col-md-6 mb-4">
                  <div class="card border-0 shadow-sm h-100">
                     <div class="row no-gutters">
                        <div class="col-md-5">
                           <img src="{{ asset('frontend/images/service1.jpg') }}" class="card-img h-100" style="object-fit: cover;" alt="Golden Wheat">
                        </div>
                        <div class="col-md-7">
               ...
               <div class="col-md-6 mb-4">
                  <div class="card border-0 shadow-sm h-100">
                     <div class="row no-gutters">
                        <div class="col-md-5">
                           <img src="{{ asset('frontend/images/service3.jpg') }}" class="card-img h-100" style="object-fit: cover;" alt="Highland Maize">
                        </div>
                        <div class="col-md-7">
                           <div class="card-body p-4">
            ...
            <div class="row">
               <div class="col-md-6 mb-4">
                  <div class="card border-0 shadow-sm h-100">
                     <div class="row no-gutters">
                        <div class="col-md-5">
                           <img src="{{ asset('frontend/images/service1.jpg') }}" class="card-img h-100" style="object-fit: cover;" alt="Organic Tomato">
                        </div>
                        <div class="col-md-7">
                           <div class="card-body p-4">
               ...
               <div class="col-md-6 mb-4">
                  <div class="card border-0 shadow-sm h-100">
                     <div class="row no-gutters">
                        <div class="col-md-5">
                           <img src="{{ asset('frontend/images/service2.jpg') }}" class="card-img h-100" style="object-fit: cover;" alt="Fresh Potato">
                        </div>
                        <div class="col-md-7">
                           <div class="card-body p-4">
            ...
            <div class="row">
               <div class="col-md-6 mb-4">
                  <div class="card border-0 shadow-sm h-100">
                     <div class="row no-gutters">
                        <div class="col-md-5">
                           <img src="{{ asset('frontend/images/news1.jpg') }}" class="card-img h-100" style="object-fit: cover;" alt="Mango Orchard">
                        </div>
                        <div class="col-md-7">
                           <div class="card-body p-4">
            ...
            <div class="row">
               <div class="col-md-6 mb-4">
                  <div class="card border-0 shadow-sm h-100">
                     <div class="row no-gutters">
                        <div class="col-md-5">
                           <img src="{{ asset('frontend/images/news2.jpg') }}" class="card-img h-100" style="object-fit: cover;" alt="Golden Jute">
                        </div>
                        <div class="col-md-7">
                           <div class="card-body p-4">
