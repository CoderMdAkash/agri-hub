...
@section('title', 'Agricultural Information Hub - Home')

@section('meta_description', 'Comprehensive Agricultural Information Hub providing farming guides, detailed crop information, pest control strategies, and expert advice for farmers.')
      ...
      <div class="carousel-inner" role="listbox">
         ...
         <div class="carousel-item active">
            <div class="carousel-img-wrap">
               <img src="{{ asset('frontend/images/banner.jpg') }}" alt="Agricultural Information Hub" class="d-block img-fluid">
            ...
            <div class="carousel-caption d-none d-md-block">
               <div class="slider-content">
                  ...
                  <div class="banner-buttons">
                     <a href="{{ route('farming.guides') }}" class="btn btn-success btn-lg px-4 py-2 mr-2 font-weight-bold shadow-sm" style="background-color: #6b7908; border-color: #6b7908;">Explore Farming Guides</a>
                     <a href="{{ route('contact') }}" class="btn btn-outline-light btn-lg px-4 py-2 font-weight-bold shadow-sm">Ask An Expert</a>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="carousel-item">
            <div class="carousel-img-wrap">
               <img src="{{ asset('frontend/images/chose.jpg') }}" alt="Farming Guides & Practices" class="d-block img-fluid">
               <div class="carousel-overlay"></div>
            </div>
            <div class="carousel-caption d-none d-md-block">
               <div class="slider-content">
                  ...
                  <div class="banner-buttons">
                     <a href="{{ route('farming.guides') }}" class="btn btn-warning text-dark btn-lg px-4 py-2 mr-2 font-weight-bold shadow-sm">View Guides</a>
                     <a href="{{ route('crop.details') }}" class="btn btn-outline-light btn-lg px-4 py-2 font-weight-bold shadow-sm">Crop Profiles</a>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="carousel-item">
            <div class="carousel-img-wrap">
               <img src="{{ asset('frontend/images/news2.jpg') }}" alt="Integrated Pest Management" class="d-block img-fluid">
               <div class="carousel-overlay"></div>
            </div>
            <div class="carousel-caption d-none d-md-block">
               <div class="slider-content">
                  ...
                  <div class="banner-buttons">
                     <a href="{{ route('pest.control') }}" class="btn btn-info btn-lg px-4 py-2 mr-2 font-weight-bold shadow-sm">Pest Control Guide</a>
                     <a href="{{ route('contact') }}" class="btn btn-outline-light btn-lg px-4 py-2 font-weight-bold shadow-sm">Consult Specialist</a>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="row d_flex">
         <div class="col-lg-6 col-md-12">
            <div class="titlepage text_align_left">
               ...
               <a class="read_more" href="{{ route('about') }}">Learn More About Hub</a>
            </div>
         </div>
         <div class="col-lg-6 col-md-12">
            <div class="row d_flex">
               <div class="col-md-7">
                  <div class="about_img">
                     <figure><img src="{{ asset('frontend/images/about_img.jpg') }}" alt="Farming Knowledge"/></figure>
                  </div>
               </div>
               <div class="col-md-5">
                  <div class="about_img">
                     <figure><img src="{{ asset('frontend/images/about_img1.jpg') }}" alt="Crop Science"/></figure>
                  </div>
               </div>
            </div>
         </div>
   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-md-4 mb-4">
            <div class="services_box_main">
               <div class="services_box text_align_left">
                  <figure><img src="{{ asset('frontend/images/service1.jpg') }}" alt="Farming Guides"/></figure>
                  <div class="veget">
               ...
               <a class="read_more" href="{{ route('farming.guides') }}">Explore Guides</a>
            </div>
         </div>
         ...
         <div class="col-md-4 mb-4">
            <div class="services_box_main">
               <div class="services_box text_align_left">
                  <figure><img src="{{ asset('frontend/images/service2.jpg') }}" alt="Crop Details"/></figure>
                  <div class="veget">
               ...
               <a class="read_more" href="{{ route('crop.details') }}">View Crop Profiles</a>
            </div>
         </div>
         ...
         <div class="col-md-4 mb-4">
            <div class="services_box_main">
               <div class="services_box text_align_left">
                  <figure><img src="{{ asset('frontend/images/service3.jpg') }}" alt="Pest Control"/></figure>
                  <div class="veget">
               ...
               <a class="read_more" href="{{ route('pest.control') }}">Learn IPM Strategies</a>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="row">
         ...
         <div class="col-md-4 mb-4">
            <div class="latest {{ $index == 1 ? 'box_desho' : '' }}">
               <figure><img src="{{ asset($blog->image ?? ('frontend/images/news'.(($index % 3) + 1).'.jpg')) }}" alt="{{ $blog->title }}"/></figure>
               <span>{{ $blog->created_at ? $blog->created_at->format('d M') : '15 March' }}</span>
               <div class="nostrud">
                  <h3>{{ Str::limit($blog->title, 25) }}</h3>
                  <p>{{ Str::limit(strip_tags($blog->content), 90) }}</p>
                  <a class="read_more" href="{{ route('blog.details', $blog->slug ?? $blog->id) }}">Read More</a>
               </div>
            </div>
         </div>
         @empty
         <div class="col-md-4">
            <div class="latest">
               <figure><img src="{{ asset('frontend/images/news1.jpg') }}" alt="#"/></figure>
               ...
               <div class="nostrud">
                  ...
                  <a class="read_more" href="{{ route('farming.guides') }}">Read More</a>
               </div>
            </div>
         </div>
         <div class="col-md-4">
   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-8 offset-md-2">
            ...
            @endif
            <form id="request" class="main_form" action="{{ route('contact.submit') }}" method="POST" enctype="multipart/form-data">
               @csrf
               <div class="row">
                  <div class="col-md-6">
